    ...
    <a href="{{ route('blog.show', $post->slug) }}"
       class="block bg-white rounded-xl overflow-hidden border border-gray-100 hover:shadow-md transition group h-full">
        @if($post->getFeaturedImageUrl())
            <img src="{{ $post->getFeaturedImageUrl() }}" alt="{{ $post->title }}" loading="lazy"
        ...
        <div class="p-5">
            ...
            <h3 class="text-xl font-semibold text-gray-900 mt-1 group-hover:text-blue-600 transition">{{ $post->title }}</h3>
