...
@section('breadcrumbs')
    <x-admin.breadcrumbs :items="[['label' => 'Dashboard', 'url' => route('admin.dashboard')], ['label' => 'Blog Categories']]" />
@endsection

@section('content')
    <x-admin.page-banner
        title="Blog Categories"
        subtitle="Manage categories for your blog posts"
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-4 border-b border-gray-100 flex flex-col sm:flex-row gap-3">
            <form method="GET" action="{{ route('admin.blog-categories.index') }}" class="flex-1 flex gap-3">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td class="px-4 py-3">
                            <span class="px-2 py-1 text-xs font-semibold rounded-full {{ $category->status ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700' }}">
                            ...
                            <div class="relative dropdown-container">
                                ...
                                <div class="dropdown-menu hidden absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg border border-gray-200 py-1 z-50">
                                    ...
                                    <form id="delete-form-{{ $category->id }}"
                                          action="{{ route('admin.blog-categories.destroy', $category) }}" method="POST">
                                        @csrf @method('DELETE')
                                        <button type="button"
