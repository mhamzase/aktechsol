...
@section('breadcrumbs')
    <x-admin.breadcrumbs :items="[['label' => 'Dashboard', 'url' => route('admin.dashboard')], ['label' => 'Service Categories', 'url' => route('admin.service-categories.index')], ['label' => 'Edit']]" />
@endsection

@section('content')
    <x-admin.page-banner title="Edit Service Category" subtitle="Update category information" />
