@php
    $menu = [
        ...
        [
            ...
            'icon' =>
                '<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M10 2a8 8 0 100 16 8 8 0 000-16zm-1 5H9v6h1V7zm2 0h2v6h-1V7z"/></svg>',
        ...
        [
            ...
            'label' => 'Blog',
            'icon' =>
                '<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4a2 2 0 012 2v1h2a2 2 0 012 2v9a2 2 0 01-2 2H6a2 2 0 01-2-2V6a2 2 0 012-2h2V4zm2 0v1h4V4H6zm-2 2v9a2 2 0 002 2h8a2 2 0 002-2V6h-2a2 2 0 01-2 2h-2a2 2 0 01-2-2H4z" clip-rule="evenodd"/></svg>',
            'active_patterns' => ['admin.blog-categories.*', 'admin.blog-posts.*'],
            'children' => [
                [
                    'label' => 'Posts',
                    'route' => 'admin.blog-posts.index',
                    'active_patterns' => ['admin.blog-posts.*'],
                ],
                [
                    'label' => 'Categories',
